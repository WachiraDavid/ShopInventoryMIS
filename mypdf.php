...
$output = '';
    ...
    $value1 = $_POST['startdate'];
    $value2 = $_POST['enddate'];
    $startdate = strtotime($value1);
    $enddate = strtotime($value2);

    $sql = "SELECT MONTH(TIMESTAMP ), item_name, quantity, s_price, b_price,timestamp, TIMESTAMP FROM sales WHERE TIMESTAMP  BETWEEN FROM_UNIXTIME($startdate) and FROM_UNIXTIME($enddate)";
...
';
        ...
        echo '<script> alert("There were no sales in the selected dates"); window.location= "searchreport.html"</script>';
    }
return $output;
}
function getTotal()
...
<div class="w3-section"
            ...
            <input class="w3-input w3-border w3-hover-border-black" style="width:100%;" type="date" name="startdate" required>
    </div>
    <div class="w3-section">
        <label>End Date</label>
        <input class="w3-input w3-border w3-hover-border-black" style="width:100%;" type="date" name="enddate" required>
    </div>
